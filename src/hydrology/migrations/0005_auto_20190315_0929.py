# Generated by Django 2.1.4 on 2019-03-15 09:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('hydrology', '0004_auto_20190315_0731'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('жидкие', 'Жидкие осадки'), ('твердые', 'Твердые осадки'), ('смешанные', 'Смешанные осадки')], max_length=31),
        ),
        migrations.AlterField(
            model_name='measurement',
            name='ripple',
        ...
        migrations.AlterField(
            model_name='measurement',
            name='wind_direction',
            field=models.CharField(blank=True, choices=[('штиль', 'штиль'), ('по течению', 'по течению'), ('против течения', 'против течения'), ('с левого берега', 'с левого берега'), ('с правого берега', 'с правого берега')], max_length=17),
        ),
        migrations.AlterField(
            model_name='measurement',
            name='wind_power',
            field=models.CharField(blank=True, choices=[('штиль', 'штиль'), ('слабый', 'слабый'), ('умеренный', 'умеренный'), ('сильный', 'сильный')], max_length=10),
        ),
    ]
